...
class SetUpAdhocProvisioningProfile {
    ...
    async runWithDistributionCertificateAsync(ctx, distCert) {
        ...
        if (currentBuildCredentials === null || currentBuildCredentials === void 0 ? void 0 : currentBuildCredentials.provisioningProfile) {
            appleProvisioningProfile = await this.reuseCurrentProvisioningProfileAsync(currentBuildCredentials.provisioningProfile, provisioningProfileStoreInfo, ctx, app, appleAppIdentifier, chosenDevices);
        }
        else {
    ...
    async reuseCurrentProvisioningProfileAsync(currentProvisioningProfile, provisioningProfileStoreInfo, ctx, app, appleAppIdentifier, chosenDevices) {
        ...
        else if ((0, differenceBy_1.default)(chosenDevices, currentProvisioningProfile.appleDevices, 'identifier').length > 0) {
